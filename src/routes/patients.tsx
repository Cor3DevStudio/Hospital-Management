            ...
            <CardHeader className="pb-3 pt-4 px-4">
              ...
              <div className="relative pt-2">
                ...
                <Input
                  ...
                  placeholder="Search name, ID, contact, or PhilHealth PIN…"
                  className="pl-8 h-9"
                />
              </div>
                    ...
                    <li key={p.id}>
                      ...
                      >
                        ...
                        <span className="text-xs text-muted-foreground">
                          {age !== null ? `${age}y` : "—"} · {p.gender} · {admission} ·{" "}
                          {p.archived ? "Archived" : "Active"}
                        </span>
                        <span className="text-[10px] text-muted-foreground">
                          {p.contactNumber} · Reg. {formatRegisteredDate(p.createdAt)}
                        </span>
                      </button>
                    </li>
                  );
          ...
          <Card className="flex flex-col h-full min-h-0">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-base">
                {selectedId ? "Edit Patient" : "Register Patient"}
              </CardTitle>
              {selectedPatient && (
                <div className="mt-2 flex flex-wrap gap-2 text-[11px] text-muted-foreground">
                  ...
                  <span>·</span>
                  <span>
                    Admission: {getAdmissionStatusFromMap(admissionStatusMap, selectedPatient.id)}
                  </span>
            ...
            <CardContent className="flex-1 overflow-y-auto space-y-6 p-5 border-t flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <Section title="Personal Information" subtitle="Name, birth date & contact details">
                  <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                    ...
                    <Field label="Gender">
                      <Select
                        value={form.gender}
                        onValueChange={(v) => setForm({ ...form, gender: v as Patient["gender"] })}
                      >
                    ...
                    <Field label="Civil Status">
                      <Select
                        ...
                        onValueChange={(v) =>
                          setForm({ ...form, civilStatus: v as Patient["civilStatus"] })
                        }
                      >
                        <SelectTrigger className="h-9">
                          <SelectValue />
                ...
                <Section
                  ...
                  subtitle="Home address and emergency information"
                >
                  <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                    ...
                    <Field label="Barangay">
                      <Input
                        ...
                        onChange={(e) =>
                          setForm({
                            ...form,
                            address: { ...form.address, barangay: e.target.value },
                          })
                        }
                      />
                    </Field>
                ...
                <Section
                  title="PhilHealth & Classification"
                  subtitle="Member details and special classifications"
                >
                  <div className="grid gap-3 grid-cols-1 sm:grid-cols-2">
                    ...
                    <Field label="PhilHealth Category">
                      <Select
                        ...
                        onValueChange={(v) =>
                          setForm({ ...form, philhealth: { ...form.philhealth, category: v } })
                        }
                      >
                        <SelectTrigger className="h-9">
                          <SelectValue />
                    ...
                    <Field label="Member Type">
                      <Select
                        ...
                        onValueChange={(v) =>
                          setForm({ ...form, philhealth: { ...form.philhealth, memberType: v } })
                        }
                      >
                        <SelectTrigger className="h-9">
                          <SelectValue />
                      ...
                      <div className="flex items-center gap-2">
                        <Checkbox
                          ...
                          onCheckedChange={(c) =>
                            setForm({
                              ...form,
                              seniorCitizen: { ...form.seniorCitizen, flag: Boolean(c) },
                            })
                          }
                        />
                        <Label
                      ...
                      <Field label="Senior ID Number">
                        <Input
                          ...
                          onChange={(e) =>
                            setForm({
                              ...form,
                              seniorCitizen: { ...form.seniorCitizen, idNumber: e.target.value },
                            })
                          }
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <Checkbox
                          ...
                          onCheckedChange={(c) =>
                            setForm({ ...form, pwd: { ...form.pwd, flag: Boolean(c) } })
                          }
                        />
                        <Label htmlFor="pwd" className="text-xs font-semibold cursor-pointer">
                          PWD
                        </Label>
                      </div>
                      <Field label="PWD ID Number">
                        <Input
                          ...
                          onChange={(e) =>
                            setForm({ ...form, pwd: { ...form.pwd, idNumber: e.target.value } })
                          }
              ...
              <div className="flex flex-wrap justify-end gap-2 border-t pt-3 mt-4 shrink-0">
                ...
                <Button size="sm" onClick={save}>
                  <Save className="h-3.5 w-3.5" /> {selectedId ? "Update" : "Register"}
                </Button>
              </div>
            </CardContent>
          </Card>
