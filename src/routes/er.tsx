    ...
    <>
      ...
      <div className="no-print h-[calc(100vh-3rem)] flex flex-col overflow-hidden bg-background">
        <PageHeader
          ...
          description="Manage ER triage, arrivals, treatment status, and dispositions."
        />
        <div className="flex-1 grid gap-4 p-4 md:grid-cols-[1.4fr_1fr] items-stretch min-h-0 overflow-hidden">
          <Card className="flex flex-col h-full min-h-0">
            ...
            <CardContent className="flex-1 overflow-y-auto p-0 border-t">
              ...
              <ListPagination
                page={erList.page}
                totalPages={erList.totalPages}
                totalItems={erList.totalItems}
                onPageChange={erList.setPage}
              />
            </CardContent>
          </Card>
          ...
          <Card className="flex flex-col h-full min-h-0">
            <CardHeader className="pb-2 pt-4 px-4">
              <CardTitle className="text-base">
                {editId ? "Edit ER Visit" : "Log ER Visit"}
              </CardTitle>
            </CardHeader>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setForm({ ...form, triageLevel: v as ERRecord["triageLevel"] })
                      }
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setForm({
                          ...form,
                          disposition: v as ERRecord["disposition"],
                          status: v === "Admitted" ? "Admitted" : form.status,
                        })
                      }
                    >
                      <SelectTrigger className="h-9">
                      ...
                      <SelectContent>
                        {["Admitted", "Discharged", "Transferred", "Released"].map((d) => (
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setForm({ ...form, attendingDoctor: v })}
                  >
                    <SelectTrigger className="h-9">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    value={form.attendingNurse || ""}
                    onChange={(e) => setForm({ ...form, attendingNurse: e.target.value })}
                  />
                </div>
                {form.disposition === "Admitted" && editId && !form.admissionId && (
                  <div className="rounded border p-3 space-y-2 bg-muted/30">
                    ...
                    <Input
                      ...
                      className="h-9 text-sm"
                    />
                    <Button size="sm" onClick={admitFromER}>
                      <Bed className="h-3.5 w-3.5" /> Admit Patient
                    </Button>
                  </div>
                )}
                {form.admissionId && (
                  <p className="text-xs text-muted-foreground">
                    Linked admission: {form.admissionId}
                  </p>
                )}
              </fieldset>
