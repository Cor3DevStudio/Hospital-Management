...
import { patchCf2Override, patchCf4Override } from "@/lib/services/claimFormService";
    ...
    <>
      ...
      {suiteBill && (
        <div id="cf-print-area" className="force-light">
          {activeForm === "ESOA" ? (
            <OfficialESOASheet bill={suiteBill} patient={suitePatient} hospital={state.hospital} />
          ) : activeForm === "CSF" ? (
            <OfficialCSFSheet bill={suiteBill} patient={suitePatient} admission={suiteAdmission} />
          ) : activeForm === "CF5" ? (
            <OfficialCF5Sheet
              bill={suiteBill}
              patient={suitePatient}
